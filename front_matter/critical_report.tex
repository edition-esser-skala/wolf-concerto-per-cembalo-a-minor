...
\newcommand\fancytitlehead{
	...
	\fontsize{45}{45}\selectfont\@ifundefined{@shorttitle}{\@title}{\@shorttitle}.%
}
...
\lastname{Wolf}
\title{Concerto per Cembalo}
\subtitle{(D-B Mus.ms. 23287/8)}
\instrumentation{2 ob, 2 vl, vla, b, cemb}
\maketitle
...
This edition bases upon a copy in the Staatsbibliothek zu Berlin. The digital version of the manuscript is available at \url{https://resolver.staatsbibliothek-berlin.de/SBB0001973000000000} (siglum Mus.ms. 23287/8; see also RISM ID 452522032).

In general, this edition closely follows the manuscript. Any changes that were introduced by the editor are indicated by italic type (lyrics, dynamics and directions), parentheses (expressive marks and bass figures) or dashes (slurs and ties). Accidentals are used according to modern conventions. Asterisks denote changes that are clarified in the detailed remarks below.\footnote{Abbreviations: b, basses; cemb, cembalo; Ms, manuscript; ob, oboe; r, rest; vl, violin; vla, viola.}
...
\begin{longtable}{lll L{10cm}}
	...
	\midrule \endhead
	1 & 50  & cemb  & right hand, 13th sixteenth in Ms: f′′′16 \\
    & 52  & vla   & 2nd half of bar in Ms: r4–g′4 \\
    & 100 & b     & 2nd quarter in Ms: e4 \\
    & 172 & vl 1  & 1st quarter in Ms: r4 \\
    & 203 & vl 2  & 2rd quarter in Ms: f4 \\
  3 & 16  & vla   & 4th/5th eighth in Ms: e′8–e′8 \\
	\bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/wolf-concerto-per-cembalo-a-minor}. Your help will be greatly appreciated.
